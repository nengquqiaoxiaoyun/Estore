...
<head>
    ...
    <script type="text/javascript" src="${root}/themes/ecmoban_jumei/js/action.js"></script>
    <script type="text/javascript" src="${root}/themes/ecmoban_jumei/js/mzp-packed-me.js"></script>
    <script type="text/javascript" src="${root}/themes/ecmoban_jumei/js/good_detail.js"></script>
</head>
<body>
...
<div class="block clearfix">
    <div class="AreaR" style="width:950px;">
        ...
        <div id="goodsInfo" class="clearfix">
            ...
            <div class="imgInfo">
                <!-- 当前显示的大图 -->
                <a href="${root}/${requestScope.goodDetail.imgurl}"
                   id="zoom1" class="MagicZoom MagicThumb">
                    <img src="${root}/${requestScope.goodDetail.imgurl}"
                         width="360px;" height="360px"/>
                </a>
                <!-- 下方的图片列表 -->
                <div class="picture" id="imglist">
                    <a href="${root}/${requestScope.goodDetail.imgurl}" rel="zoom1"
                       rev="${root}/${requestScope.goodDetail.imgurl}">
                        <img src="${root}/${requestScope.goodDetail.imgurl}" class="onbg"/>
                    </a>
                </div>
            ...
            <!-- 商品文字信息 -->
            <div class="textInfo">
                <h1 class="clearfix">${requestScope.goodDetail.name}</h1>
                <ul class="ul2 clearfix">
                    <li class="clearfix">
                        <dd>
                            <strong>市场售价：</strong>
                            <font class="market">${requestScope.goodDetail.marketprice}元</font>
                        </dd>
                    </li>
                    <li class="clearfix">
                        <dd>
                            <strong>本店售价：</strong>
                            <font class="shop">${requestScope.goodDetail.estoreprice}元</font>
                        </dd>
                    </li>
                    <li class="clearfix">
                        <dd>
                            <strong>商品库存：</strong> ${requestScope.goodDetail.num}件
                        </dd>
                    </li>
                    <li class="clearfix">
                        <dd>
                            <strong>商品分类：</strong> ${requestScope.goodDetail.category}
                        </dd>
                    </li>
                    <li class="clearfix" style="width:100%;">
                        <dd>
                            ...
                            <div style="text-indent: 2em;">
                                ${requestScope.goodDetail.description}
                            </div>
                        </dd>
                    </li>
                </ul>
                ...
                <div id="com_h">
                    <blockquote>
                        ...
                        <div class="more_pic"
                            ...
                            <img src="${root}/${requestScope.goodDetail.imgurl}" alt="${requestScope.goodDetail.name}"
                                 class="load_img"
                                 style="border: 0px; display: block; margin-left: auto; margin-right: auto; background-image: url(${root}/images/loading.gif); height: 710px; width: 640px; background-position: 50% 50%; background-repeat: no-repeat no-repeat;"/>
                        </div>
                    </blockquote>
                    <blockquote>
                        <div class="box">
                ...
                <div class="boxCenterList clearfix ie6" style="padding:2px;">
                    <div class="goodsItem" style="padding: 10px 2px 15px 2px;">
                        <a href="javascript:;"><img
                                src="${root}/images/201501/thumb_img/137_thumb_G_1420325495120.jpg"
                    ...
                    <div class="goodsItem" style="padding: 10px 2px 15px 2px;">
                        <a href="javascript:;"><img
                                src="${root}/images/201501/thumb_img/134_thumb_G_1421183937155.jpg"
                    ...
                    <div class="goodsItem" style="padding: 10px 2px 15px 2px;">
                        <a href="javascript:;"><img
                                src="${root}/images/201501/thumb_img/140_thumb_G_1420324897667.jpg"
                    ...
                    <div class="goodsItem" style="padding: 10px 2px 15px 2px;">
                        <a href="javascript:;"><img
                                src="${root}/images/201501/thumb_img/141_thumb_G_1420324798329.jpg"
                                ...
                                <table width="710" border="0" cellspacing="5" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="comment_rank" type="radio" value="1"
                                                ...
                                                src="${root}/themes/ecmoban_jumei/images/stars1.gif"/> <input
                                                name="comment_rank" type="radio" value="2"
                                                id="comment_rank2"/> <img
                                                src="${root}/themes/ecmoban_jumei/images/stars2.gif"/> <input
                                                name="comment_rank" type="radio" value="3"
                                                id="comment_rank3"/> <img
                                                src="${root}/themes/ecmoban_jumei/images/stars3.gif"/> <input
                                                name="comment_rank" type="radio" value="4"
                                                id="comment_rank4"/> <img
                                                src="${root}/themes/ecmoban_jumei/images/stars4.gif"/> <input
                                                name="comment_rank" type="radio" value="5" checked="checked"
                                                id="comment_rank5"/> <img
                                                src="${root}/themes/ecmoban_jumei/images/stars5.gif"/></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div style="padding-left:15px; text-align:left; float:left;">
                                                验证码：<input type="text" name="captcha" class="inputBorder"
                                                    ...
                                                    src="${root}/validatecode.jsp" alt="captcha"
                                                    onClick="this.src='validatecode.jsp?'+Math.random()"
                                                    class="captcha">
                                            </div>
                                            <input name="" type="submit" value="评论咨询"
