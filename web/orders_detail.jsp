                ...
                <div class="userCenterBox boxCenterList clearfix"
                    ...
                    <table width="100%" border="0" cellpadding="5" cellspacing="1"
                        ...
                        <tr>
                            ...
                            <td align="left">${orderDetail.address}</td>
                        </tr>
                    </table>
                    <div class="blank"></div>
                    ...
                    <table width="100%" border="0" cellpadding="5" cellspacing="1"
                        ...
                        <c:forEach items="${requestScope.orderDetail.oiList}" var="orderItems">
                            <tr>
                                <td>
                                    <a href="javascript:;" class="f6">${orderItems.good.name}</a>
                                </td>
                                <td>${orderItems.good.marketprice}元</td>
                                <td>${orderItems.good.estoreprice}元</td>
                                <td align="center">${orderItems.buynum}</td>
                                <td>${orderItems.buynum * orderItems.good.estoreprice}元</td>
                            </tr>
                        </c:forEach>
