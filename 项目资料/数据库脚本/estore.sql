...
-- 正在导出表  estore.goods 的数据：~6 rows (大约)
...
-- 正在导出表  estore.orders 的数据：~3 rows (大约)
...
-- 正在导出表  estore.user 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `email`, `nickname`, `password`, `role`, `phone`) VALUES
	(1, 'aaa@niubee.com', '任溶溶', '96e79218965eb72c92a549dd5a330112', 'admin', '13651825024');
